...
export const productPages = [
  {
    ...
    h1: 'Compare AI Models Side by Side with the Same Prompt',
    description: 'Compare AI models side by side with the same prompt in Chrome or Microsoft Edge. Review answers, edits, and provider terms before you pick a workflow.',
  ...
  },
  {
    ...
    h1: 'ChatGPT Chrome Extension for Comparing Multiple AI Models',
    description: 'Install a ChatGPT Chrome extension (and Edge add-on) that sends the same prompt to ChatGPT, Gemini, DeepSeek, and more—local-first, no extra account.',
    title: 'ChatGPT Chrome Extension to Compare AI Models | ModelAny',
    models: ['chatgpt', 'gemini', 'deepseek', 'qwen'],
  ...
  },
  {
    ...
    intent: 'model-comparison-workflow',
    h1: 'Side-by-Side AI Comparison with the Same Prompt',
    description: 'Run a repeatable side-by-side AI comparison: one task, one prompt, multiple models. Use this workflow to evaluate ChatGPT, Gemini, DeepSeek, and more.',
    models: ['chatgpt', 'gemini', 'deepseek', 'qwen'],
    priority: 'P1',
  },
  {
    ...
    intent: 'browser-extension',
    lang: 'zh',
    h1: 'AI 浏览器插件：用同一提示词比较 ChatGPT 等多个模型',
    description: '在 Chrome 或 Microsoft Edge 安装 ModelAny：一次输入问题，同时发给 ChatGPT、Gemini、DeepSeek 与国产大模型，并排比较答案。本地优先，不上传到自有服务器。',
    models: ['chatgpt', 'gemini', 'deepseek', 'qwen'],
  ...
  },
  {
    ...
    intent: 'model-comparison-workflow',
    lang: 'zh',
    h1: '对比大模型：用同一提示词并排验证答案',
    description: '不要把不同提示词下的单次输出当成结论。先固定任务与成功标准，再用 ModelAny 向多个大模型发送同一提示词，并排检查事实、可执行性与修改成本。',
    models: ['chatgpt', 'gemini', 'deepseek', 'qwen'],
